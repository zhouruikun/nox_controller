...
* 作    者：   D&K
**************************************************************************************/ 
void DK_GPIO_Init(u8 GPIOx,u16 GPIOx_x,u8 Type)  //参数类型参照 "GPIO.h"
{			  
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE); //复用管脚(除了输入出外其它都要复用)	
    switch(Type)
    {
        case 1:
...
* 作    者：   D&K
**************************************************************************************/ 
void DK_GPIO_Write_H(GPIO_TypeDef* GPIOx, u8 PortVal)
{
    u16 ReadValue;
    u16 WriteValue; 
...
* 作    者：   D&K
**************************************************************************************/ 
void DK_GPIO_Write_L(GPIO_TypeDef* GPIOx, u8 PortVal)
{
    u16 ReadValue;
    u16 WriteValue; 
    assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
